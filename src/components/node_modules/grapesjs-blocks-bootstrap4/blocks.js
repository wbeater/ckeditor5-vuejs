export default (editor, config = {}) => {
  ...
  if (cats.layout) {
    ...
    if (blocks.column_break) {
      bm.add('bs_column_break').set({
        ...
        category: 'Bootstrap Layout',
        content: {
          type: 'bs_column_break'
        }
      });
    }

    if (blocks.media_object) {
      bm.add('bs_media_object').set({
        label: c.labels.media_object,
        category: 'BS4 Components',
        attributes: {class:'fa fa-columns'},
        content: `<div class="bs-media media">
                 <img class="mr-3" src="">
  ...
  if (blocks.select) {
    bm.add('bs_select', {
      ...
      category: 'BS4 Form',
      content: `<select class="form-control bs-select">
  ...
  if (blocks.button) {
    bm.add('bs_button', {
      ...
      category: 'BS4 Basics',
      content: '<style></style><button class="btn btn-primary">Send</button>',
    });
  }

  if (blocks.button_group) {
    bm.add('bs_button_group', {
      label: c.labels.button_group,
      category: 'BS4 Basics',
      attributes: {class:'fa fa-link'},
      content: {
        type: 'bs_button_group'
      }
    });
  }

  if (blocks.button_toolbar) {
    bm.add('bs_button_toolbar', {
      label: c.labels.button_toolbar,
      category: 'BS4 Basics',
      attributes: {class:'fa fa-link'},
      content: {
        type: 'bs_button_toolbar'
      }
    });
  }
  ...
  if (blocks.label) {
    bm.add('bs_label', {
      ...
      category: 'BS4 Basics',
      content: '<label class="bs-label">Label</label>',
    });
  }
