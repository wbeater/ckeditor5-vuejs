export default (editor, dc, traits, config = {}) => {
    ...
    dc.addType('bs_select', {
        model: defaultModel.extend({
            ...
            isComponent(el) {
                if(el && el.classList && el.classList.contains('bs-select')){ //replaced from el.tagName === 'SELECT'
                    return {type: 'bs_select'};
                }
            },
        }),
    ...
    traitManager.addType('bs_select-options', {
        events:{
            'keyup': 'onChange',
        },
