...
export default (editor, config = {}) => {
  ...
  if (cats.basic) {
    if (blocks.default) {
      domc.addType('bs_default', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            tagName: 'div',
            traits: [
              {
                type: 'bs_class_select',
                options: [
                  {value: '', name: 'Default'},
  ...
  if (cats.layout) {
    ...
    if (blocks.row) {
      domc.addType('bs_row', {
        model: defaultModel.extend({
          ...
          isComponent(el) {
            if(el && el.classList && el.classList.contains('bs-row')) {
              return {type: 'bs_row'};
            }
          }
        }),
    ...
    if (blocks.column) {
          ...
          isComponent(el) {
            ...
            if(el && el.classList) {
              el.classList.forEach(function(klass) {
                if(klass=="bs-col" || klass.match(/^col-/)) {
                  match = true;
                }
              });
            }
            if(match) return {type: 'bs_column'};
          }
        }),
        view: defaultView
      });

      domc.addType('bs_column_break', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
          ...
          isComponent(el) {
            if(el && el.classList && el.classList.contains('w-100') && el.tagName=='DIV' && el.parentElement.classList.contains('row')) { // also check if parent is `.row`
              return {type: 'bs_column_break'};
            }
          }
        }),
        view: defaultView
      ...
      domc.addType('bs_media_object', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Media Object',
            tagName: 'div',
            classes: ['bs-media', 'media']
          })
        }, {
          isComponent(el) {
            if(el && el.classList && el.classList.contains('bs-media')) {
              return {type: 'bs_media_object'}; //media
            }
          }
        }),
        view: defaultView
  ...
  if (cats.components) {
    ...
    if (blocks.card) {
      domc.addType('bs_card', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Card',
            classes: ['bs_card', 'card'],
            traits: [
              {
                type: 'checkbox',
                label: 'Image Top',
          ...
          createCardComponent(prop) {
            ...
            const type = 'bs_' + prop.replace(/-/g,'_').replace(/img/g,'image')
      ...
      domc.addType('bs_card_image_top', {
        model: imageModel.extend({
          defaults: Object.assign({}, imageModel.prototype.defaults, {
      ...
      domc.addType('bs_card_image_overlay', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
      ...
      domc.addType('bs_card_image_bottom', {
        model: imageModel.extend({
          defaults: Object.assign({}, imageModel.prototype.defaults, {
      ...
      domc.addType('bs_card_container', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
