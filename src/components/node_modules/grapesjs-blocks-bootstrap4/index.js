...
export default grapesjs.plugins.add('grapesjs-blocks-bootstrap4', (editor, opts = {}) => {
  ...
  const default_labels = {
    // LAYOUT
    container: 'BS4 Container',
    row: 'BS4 Row',
    column: 'BS4 Column',
    column_break: 'BS4 Column Break',
    media_object: 'BS4 Media Object',
    // COMPONENTS
    alert: 'BS4 Alert',
    tabs: 'BS4 Tabs',
    tab: 'BS4 Tab',
    tabPane: 'BS4 Tab Pane',
    badge: 'BS4 Badge',
    button: 'BS4 Button',
    button_group: 'BS4 Button Group',
    button_toolbar: 'BS4 Button Toolbar',
    card: 'BS4 Card',
    card_container: 'BS4 Card Container',
    collapse: 'BS4 Collapse',
    dropdown: 'BS4 Dropdown',
    dropdown_menu: 'BS4 Dropdown Menu',
    dropdown_item: 'BS4 Dropdown Item',
    // TYPOGRAPHY
    text: 'BS4 Text',
    header: 'BS4 Header',
    paragraph: 'BS4 Paragraph',
    // BASIC
    image: 'BS4 Image',
    link: 'BS4 Link',
    list: 'BS4 Simple List',
    // FORMS
    form: 'BS4 Form',
    input: 'BS4 Input',
    file_input: 'BS4 File',
    input_group: 'BS4 Input group',
    textarea: 'BS4 Textarea',
    select: 'BS4 Select',
    select_option: '- Select option -',
    option: 'BS4 Option',
    label: 'BS4 Label',
    checkbox: 'BS4 Checkbox',
    radio: 'BS4 Radio',
    trait_method: 'Method',
